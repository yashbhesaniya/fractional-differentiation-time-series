...
class DataLoader():
    ...
    def load_dataset(self,
        ...
        -----
        path_files: dict
            A dictionary containing tags used as table prefixes as keys and their respective file paths as values.

        Returns:
        -----
        dataset: pandas DataFrame
            The unified dataset containing all references passed as arguments.
        '''
